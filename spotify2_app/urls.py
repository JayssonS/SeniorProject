...
urlpatterns = [
    ...
    url(r'^discover/recommendations', views.discover_recommendations, name='discover_recommendations'),
    url(r'^discover/tailor', views.discover_form, name='discover_form'),
